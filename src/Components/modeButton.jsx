...
const Switch = () => {
  ...
  return (
    <StyledWrapper style={{translate:"0 5px"}}>
...
const StyledWrapper = styled.div`
  ...
  .theme-switch.dark .theme-switch__circle-container {
    left: calc(100% - var(--circle-container-offset) - var(--circle-container-diameter));
  }

  .theme-switch.dark .theme-switch__moon {
  ...
  .theme-switch.dark .theme-switch__stars-container {
    top: 50%;
